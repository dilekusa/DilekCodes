...
public class BasicString {
	...
	public static void main(String[] args) {
		 ...
		 * following operations: 1)Sum the lengths of A and B 2)Determine if is
		 * lexicographically larger than (i.e.: does come before in the
		 * dictionary?). 3)Capitalize the first letter in and and print them on
		 ...
		 * string . The strings are comprised of only lowercase English letters.
		 * Output Format There are three lines of output: 1)For the first line,
